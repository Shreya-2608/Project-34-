...
function setup() {
  ...
  box9 = new Box(750, 135, 70, 70);
  box10 = new Box(750, 170, 70, 70);
  box11 = new Box(750, 205, 70, 70);
  box12 = new Box(750, 240, 70, 70);
  box13 = new Box(750, 275, 70, 70);
  
  box14 = new Box(900, 100, 70, 70);
  box15 = new Box(900, 135, 70, 70);
  box16 = new Box(900, 170, 70, 70);
  box17 = new Box(900, 205, 70, 70);
  box18 = new Box(900, 240, 70, 70);
  box19 = new Box(900, 275, 70, 70);
  box20 = new Box(900, 310, 70, 70);
  box21 = new Box(900, 345, 70, 70);
